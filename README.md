...
- 📄 [Python Google Colab Notebook (.ipynb)](./BUS_266_JIRA_Bug_Project.ipynb) — Full ETL pipeline: taxonomy, aging, org join, cost estimate, CSV export rendering clean datasets (5 CSVs), analysis-ready outputs feeding all charts and the dashboard
